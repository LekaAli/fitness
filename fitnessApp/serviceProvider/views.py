...
def add_service_provider(request):
    try:
        if request.method == "POST":
            ...
            service_provider = Serviceprovider.objects.create(firstname=firstname,lastname=lastname,category=category,qualification=qualification,speciality=speciality)
